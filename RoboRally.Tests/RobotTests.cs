...
namespace RoboRally.Tests
{
    ...
    public class RobotTest
    {
        ...
        public void ProgramTest ()
        {
            ...
            Assert.AreEqual (FieldDirection.East, _robot.CurrentDirection, string.Format ("Robot facing should be {0}", FieldDirection.East));
        ...
        private static void DoAndCheckRobotAction (Robot robot, RobotAction action, int expectedX, int expectedY, FieldDirection facing, FieldDirection expectedFacing)
        {
        ...
        public void MovesTest ()
        {
            ...
            DoAndCheckRobotAction (_robot, RobotAction.Move1, 1, 0, FieldDirection.East, FieldDirection.East);

            DoAndCheckRobotAction (_robot, RobotAction.Move2, 1, 2, FieldDirection.South, FieldDirection.South);

            DoAndCheckRobotAction (_robot, RobotAction.Move3, 4, 2, FieldDirection.East, FieldDirection.East);
          
            DoAndCheckRobotAction (_robot, RobotAction.BackTurn, 5, 2, FieldDirection.West, FieldDirection.West); 

            DoAndCheckRobotAction (_robot, RobotAction.RotateLeft, 5, 2, FieldDirection.West, FieldDirection.South);

            DoAndCheckRobotAction (_robot, RobotAction.RotateRight, 5, 2, FieldDirection.South, FieldDirection.West);

            DoAndCheckRobotAction (_robot, RobotAction.UTurn, 5, 2, FieldDirection.West, FieldDirection.East);
